               ...
               <div className="col-12 col-lg-4 my-3">
                  <div className="border-logo">
                     <p className="text-center mt-3">
                        Punkt Konsultacyjno-Diagnostyczny działa w ramach Poradni NZOZ "Nadzieja Rodzinie"
                     </p>
                     <img src={logoNzoz} alt="Logo" />
                     <p className="text-center mt-3">prowadzonej przez Stowarzyszenie "Nadzieja Rodzinie"</p>
               ...
               <div className="col-12 col-lg-8">
                  <div className="row">
                     <div className="col-12 col-lg-6">
                        <div className="card-kontact">
                           <i className="bi bi-clock"></i>
                           <div className="row">
                              <div className="col">
                                 <p className="text-end">wtorek</p>
                              </div>
                              <div className="col">
                           ...
                           <div className="row">
                              <div className="col">
                                 <p className="text-end">czwartek</p>
                              </div>
                              <div className="col">
                     ...
                     <div className="col-12 col-lg-6">
                        <div className="card-kontact">
                           <a href="https://goo.gl/maps/aWWFrQvb7QWLpdQd8" target="_blank" rel="noopener noreferrer">
                              ...
                              <p className="text-center">Karczówkowska 36 25-711 Kielce</p>
                           </a>
                        </div>
                     </div>
                  </div>
